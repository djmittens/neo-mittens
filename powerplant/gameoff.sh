...
nvidia-settings --assign CurrentMetaMode="DP-4: 7680x2160_120 +0+0 {ForceCompositionPipeline=On, AllowGSYNCCompatible=On}, HDMI-0: 2560x1440_120 +7680+0 {ForceCompositionPipeline=On}"
